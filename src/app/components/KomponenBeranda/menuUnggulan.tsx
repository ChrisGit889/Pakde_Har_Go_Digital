...
function MenuUnggulan() {
  const menu = [
    {
      ...
      deskripsi: "Nasi Goreng Ayam khas Pakde dengan kecap manis, disajikan dengan ayam, dan kerupuk udang",
    },
    {
      gambar: "/images/Nasi_Goreng_Ayam.jpg",
      nama: "Nasi Goreng Ayam",
  ...
  return (
    <Row className="justify-content-center gap-4 m-0"
    style={{ 
                     marginBottom: "40px"
                    }}>
      {menu.map((item, index) => (
        <Col key={index} md={3}>
          <Card style={{ borderRadius: "12px", overflow: "hidden" }}>
            <Card.Img src={item.gambar} style={{ height: "180px", objectFit: "cover" }} />
            <Card.Body>
              ...
              <Card.Text style={{ fontSize: "14px" }}>{item.deskripsi}</Card.Text>
