...
const navLinks = [
  ...
  { name: 'Karyawan', href: '/admin/karyawan', icon: '/images/profilePutih.png' }, // Pastikan Anda upload ikon ini
];
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-header">
        <Image src="/images/LogoPakDe.png" alt="Logo Pakde Har" width="120" />
      </div>
